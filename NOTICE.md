...
| [tmustier/pi-for-excel](https://github.com/tmustier/pi-for-excel) | Workbook overview, selection context and change tracker, vendored into `taskpane/shared/vendor/pi-context.js` by `scripts/vendor-pi-context.mjs`; plain-value cell convention in `daemon/office-tools.mjs`. License text: `taskpane/shared/vendor/pi-context.LICENSE` (Copyright (c) 2026 Thomas Mustier). | MIT |
