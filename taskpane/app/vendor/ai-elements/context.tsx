...
export const ContextContentFooter = ({
  ...
  return (
    ...
    >
      {children ?? (
        <>
          <span className="text-muted-foreground">{translate("Total cost")}</span>
          <span>{totalCost}</span>
        </>
      )}
    </div>
...
export const ContextInputUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-muted-foreground">{translate("Input")}</span>
...
export const ContextOutputUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-muted-foreground">{translate("Output")}</span>
...
export const ContextReasoningUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-muted-foreground">{translate("Reasoning")}</span>
...
export const ContextCacheUsage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="text-muted-foreground">{translate("Cache")}</span>
