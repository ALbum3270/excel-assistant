...
Excel Assistant, working in live Excel, the harder setting, is at the same level as Claude Code with Claude Haiku 4.5: the gap is within the sampling error of a 100-task run.
