...
- **撤销多种修改**：恢复点覆盖值、公式、格式、排序、清空、行列、工作表、表格、工作表筛选、隐藏行列、冻结窗格，以及图表创建和部分属性更新。恢复之后还能重做。
...
- 图表删除和数据源变更、透视表、批注、复制工作表及 COM 工具写入仍没有完整恢复点。表格、筛选、隐藏行列和冻结窗格的新恢复路径还需要在真实 Excel 中验收。
